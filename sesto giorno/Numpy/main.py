...
from DatasetPipeline import FieldParser, RecordValidator, PreprocessPipeline

RAW_RECORDS: List[Dict[str, Any]] = [ #DEVE essere lista di dizionari con chiavi qualunque e valori numeri
...
def main() -> None:
    ...
    pipeline = PreprocessPipeline(parser, validator)
